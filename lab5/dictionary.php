...
<!-- Ex. 1: File of Dictionary -->
	...
	<?php
		...
		$lines = file($filename);
		$totlaWord = count($lines);
		$totalSize = filesize($filename);
		
		print "My dictionary has $totlaWord total words
        and
        size of $totalSize bytes."
	?>
...
//                implement here.
			...
			$todaysWord = getWordsBynumber($lines,3);	
        ?>
		<ol>
			<?php
				foreach($todaysWord as $word){
					<li><></li>
				}
			?>
		</ol>
